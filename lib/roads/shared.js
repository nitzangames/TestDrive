...
// --- Constants ---------------------------------------------------------------
export const ROAD_HALF_WIDTH        = 15;     // m (full asphalt corridor)
export const ROAD_OFFSET_Y          = 0.05;   // m above polyline Y for road surface
export const COLOR_TRANSITION_WIDTH = 25;     // m — asphalt fade
export const TERRAIN_TRANSITION_WIDTH = 50;   // m — terrain Y blend
export const TOTAL_BAND             = ROAD_HALF_WIDTH + TERRAIN_TRANSITION_WIDTH;
export const EARTH_PER_M            = 18;     // m of |ΔY| at which exposed-rock tint reaches full
