...
// Generous enough to cover the full carve influence band (ROAD_HALF_WIDTH
// + TRANSITION_WIDTH = 15 + 50 = 65 m) so the wheel-pose sampler always
// finds a road when the visible terrain underneath has been carved toward it.
const SEARCH_RADIUS = 80;          // m
