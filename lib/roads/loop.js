...
export function buildLoopRoad({ seed, terrainHeightFn, isOnWater }) {
  ...
  //     steering input.
  laplacianSmoothXZClosed(smoothed, 200);
  ...
  // 3d. Measure the worst residual turn radius for logging. Uses a
  //     wider stencil (5 m arc on each side) to ignore local noise.
