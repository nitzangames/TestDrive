...
export class MainMenu {
  ...
  _buildHTML(root) {
    ...
    root.innerHTML = `
      ...
      ">
        <div style="position:absolute;top:10%;left:0;right:0;font-size:120px;font-weight:700;letter-spacing:0.04em;white-space:nowrap;">JUST DRIVE</div>
        <div style="position:absolute;bottom:30%;width:84%;display:flex;flex-direction:column;align-items:stretch;gap:18px;">
          <label style="font:500 42px ui-monospace,Menlo,monospace;opacity:0.85;text-align:left;letter-spacing:0.04em;">Traffic</label>
